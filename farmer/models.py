...
class CustomUser(AbstractUser):
    ...
    pancard_file = models.FileField(upload_to='farmer_files/', null=True, blank=True)

    land_location = models.CharField(max_length=80, blank=True, null=True)
    land_owner = models.CharField(max_length=40, blank=True, null=True)
    land_size = models.CharField(max_length=40, blank=True, null=True)
    sand_type = models.CharField(max_length=40, blank=True, null=True)
    crop = models.CharField(max_length=40, blank=True, null=True)
    yield_quantity = models.DecimalField(max_digits=15, decimal_places=2, default=0.00)
    land_photo = models.FileField(upload_to='farmer_files/', null=True, blank=True)
